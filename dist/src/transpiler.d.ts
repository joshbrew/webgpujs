...
export declare class WGSLTranspiler {
    ...
    static convertToWebGPU(func: Function | string, shaderType?: 'compute' | 'vertex' | 'fragment', bindGroupNumber?: number, nVertexBuffers?: number, workGroupSize?: number, gpuFuncs?: (Function | string)[], variableTypes?: {
        [key: string]: string | {
            binding: string;
        };
    }): TranspiledShader;
